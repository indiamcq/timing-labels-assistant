...
The EXE is on Github [Timing-Labels-Assistant.exe](https://github.com/indiamcq/timing-labels-assistant/tree/master/current/Timing-Labels-Assistant.exe) v1.2.4
